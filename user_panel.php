                                ...
                                echo '</tr>';
                                 foreach ($data as $row) {
                                    ...
                                    if ($row['booking_status'] == 'pending') {
                                        echo '<td><button class="button_av" onclick="cancelBooking(' . $row['booking_id'] . ')">Cancel</button></td>';
                                    }
                                    echo'</tr>';
                                }
                                echo '</table>';
                                ...
                                echo '</tr>';
                                 foreach ($data as $row) {
                                    ...
                                    if ($row['rental_status'] == 'pending') {
                                        echo '<td><button class="button_av" onclick="cancelRental(' . $row['id'] . ')">Cancel</button></td>';
                                    }
                                    echo '</tr>';
                                }
                                echo '</table>';
